...
async def main():
    ...
    # Is bot instance ko globally save kar rahe hain taaki app.py ise direct use kar sake
    ...
    # 1. Start Telegram Bot Asynchronously (Non-Blocking)
    await bot_app.initialize()
    await bot_app.start()
    await bot_app.updater.start_polling(drop_pending_updates=True)
    print("✅ Bot Started Polling!", flush=True)

    # 2. Start Quart Web Server in the SAME Event Loop (Just like src project)
